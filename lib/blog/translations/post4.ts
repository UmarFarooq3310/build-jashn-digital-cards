...
export const POST_4_CONTENT: Record<string, LocalizedBlogContent> = {
  "en": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "id": "top-10-nfc-digital-visiting-card-design-trends-professionals-design-and-wording-strategies",
      ...
      },
      {
        ...
        "id": "top-10-nfc-digital-visiting-card-design-trends-professionals-whatsapp-sharing-and-rsvp",
      ...
      },
      {
        ...
        "id": "top-10-nfc-digital-visiting-card-design-trends-professionals-pro-tips-and-execution",
  ...
  "ur": {
    "intro": "خوش آمدید! کارڈزی ایک عالمی ڈیجیٹل جشن اور نیٹ ورکنگ پلیٹ فارم ہے جس کا مقصد آپ کے خاص لمحات جیسے کہ شادی، نکاح، عید، سالگرہ اور کاروباری رابطہ کاری کو جدید، متحرک اور یادگار بنانا ہے۔ اس جامع گائیڈ میں، ہم \"Top 10 NFC & Smart Digital Visiting Card Design Trends for Professionals\" پر تفصیل سے روشنی ڈالیں گے تاکہ آپ بغیر کسی دقت کے ایک بہترین ڈیجیٹل کارڈ یا دعوت نامہ تیار کر سکیں۔",
    "sections": [
      {
        "id": "top-10-nfc-digital-visiting-card-design-trends-professionals-overview-and-fundamentals",
  ...
  "ar": {
    "intro": "مرحباً بكم في منصة كاردزي العالمية للبطاقات الرقمية التفاعلية والدعوات الإلكترونية. تهدف هذه المقالة الشاملة إلى تقديم دليل تفصيلي حول \"Top 10 NFC & Smart Digital Visiting Card Design Trends for Professionals\" لمساعدتك في إنشاء دعوات وبطاقات معايدة مبتكرة ومبهرة.",
    "sections": [
      {
        "id": "top-10-nfc-digital-visiting-card-design-trends-professionals-overview-and-fundamentals",
        "title": "1. Overview, Significance & Modern Advantages",
