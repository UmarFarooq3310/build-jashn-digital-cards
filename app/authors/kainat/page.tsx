...
const personJsonLd = {
  ...
  '@type': 'Person',
  name: 'Kainat',
  jobTitle: 'Tech & Digital Product Strategist',
  worksFor: {
    '@type': 'Organization',
  ...
  knowsAbout: [
    'Smart Digital Visiting Cards (vCards)',
    'Paperless Corporate Networking',
    'QR Code Contact Synchronization',
        ...
        <div className="rounded-3xl border border-border bg-card p-6 sm:p-10 shadow-xs mb-10 space-y-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="relative shrink-0">
              <div className="size-28 sm:size-32 rounded-3xl bg-gradient-to-br from-amber-700 via-orange-800 to-rose-900 p-1 shadow-lg shadow-amber-950/20 overflow-hidden">
                <img
                  src="/authors/kainat.svg"
                  alt="Kainat - Tech & Digital Product Strategist"
                  width={128}
                  height={128}
            ...
            <div className="text-center sm:text-left space-y-2 flex-1">
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 px-3 py-0.5 text-xs font-bold text-amber-700 dark:text-amber-300 uppercase tracking-wider">
                  <Award className="size-3.5 text-amber-600" /> Tech &amp; Product Lead
                </span>
                <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 text-xs font-semibold text-emerald-800 dark:text-emerald-300">
                  <Sparkles className="size-3 text-emerald-500" /> 6+ Yrs Experience
                </span>
              </div>
              ...
              <p className="text-sm sm:text-base font-semibold text-amber-700 dark:text-amber-400">
                Tech &amp; Digital Product Strategist · Cardzy Digital Solutions
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-1 text-xs text-muted-foreground">
                <span className="flex items-center gap-1">
                  <MapPin className="size-3.5 text-amber-600 shrink-0" /> Lahore / Islamabad, Pakistan
                </span>
                <span className="flex items-center gap-1">
                  <GraduationCap className="size-3.5 text-emerald-600 shrink-0" /> M.S. Information Technology (LUMS)
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-border space-y-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground">Kainat</strong> is the Tech &amp; Digital Product Strategist at Cardzy Digital Solutions, leading product innovation across smart digital visiting cards (vCards), QR code synchronization, and enterprise contact sharing workflows.
            </p>
            <p>
              With an academic background in Human-Computer Interaction and over six years designing digital products for professionals, Kainat evaluates how executives, doctors, real estate consultants, and freelancers transition from disposable paper business cards to dynamic, paperless digital identities.
            </p>
            <p>
              Her research and published benchmarks compare the cost, conversion rates, and environmental impact of traditional paper business cards against tap-to-save digital vCards across corporate teams in South Asia and the Middle East.
            </p>
          </div>
          ...
          <div className="pt-6 border-t border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
              {[
                'Smart Digital Visiting Cards (vCard .vcf protocol & QR integrations)',
                'Corporate Networking ROI & Paper vs Digital Cost-Benefit Analysis',
                'Mobile Web Usability & Responsive RSVP Interface Design',
                'Paperless Enterprise Identity & Cloud Contact Synchronization',
                'Privacy-First Data Architecture & Consent Optimization',
                'Cross-Device Compatibility (iOS, Android, WhatsApp Web)',
              ].map((cred) => (
          ...
          <div className="pt-6 border-t border-border">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs font-bold">
              ...
              <a
                href="mailto:cardzyonline@gmail.com?subject=Question%20for%20Kainat"
                className="inline-flex min-h-[48px] items-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 hover:bg-muted transition-colors text-foreground"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {authorPosts.map((post) => (
              <Link
                key={post.slug}
                href={`/blog/${post.slug}`}
                className="group rounded-2xl border border-border bg-card p-5 shadow-2xs hover:border-amber-500/40 hover:shadow-md transition-all flex flex-col justify-between"
              >
                ...
                <div className="mt-4 pt-3 border-t border-border/50 flex items-center justify-between text-[11px] text-muted-foreground font-medium">
                  ...
                  <span className="text-amber-600 dark:text-amber-400 font-bold group-hover:underline">Read Master Guide →</span>
                </div>
              </Link>
            ))}
          </div>
