...
const GUIDE_HUB_TEXT: Record<string, Record<string, string>> = {
  ...
  magicGuideTitle: {
    ...
    es: "Cómo Usar los Enlaces Mágicos para Tarjetas Digitales",
    fr: "Comment Utiliser les Liens Magiques pour les Cartes Numériques",
    ar: "كيفية استخدام الروابط السحرية للبطاقات الرقمية",
    hi: "डिजिटल कार्ड के लिए मैजिक लिंक का उपयोग कैसे करें",
    zh: "如何使用数字贺卡的魔法链接",
    pt: "Como Usar Links Mágicos para Cartões Digitais",
    ru: "Как использовать волшебные ссылки для цифровых открыток",
    de: "So verwenden Sie Magic Links für digitale Karten",
    ja: "デジタルカードのプロ向け機能：マジックリンクの使い方",
    ko: "디지털 카드를 위한 매직 링크 사용 방법",
    it: "Come Usare i Magic Link per le Carte Digitali",
    tr: "Dijital Kartlar İçin Sihirli Bağlantılar Nasıl Kullanılır",
    id: "Cara Menggunakan Tautan Ajaib untuk Kartu Digital",
    ur: "ڈیجیٹل کارڈز کے لیے میجک لنکس کیسے استعمال کریں",
    bn: "ডিজিটাল কার্ডের জন্য ম্যাজিক লিঙ্ক কীভাবে ব্যবহার করবেন",
    vi: "Cách Sử Dụng Liên Kết Ma Thuật Cho Thiệp Kỹ Thuật Số",
    sw: "Jinsi ya Kutumia Viungo vya Kichawi kwa Kadi za Dijitali"
  },
  magicGuideDesc: {
    en: "Learn how to generate unique Magic Links for your digital cards to get real-time read receipts and track exactly when your guests open your invitations or wishes.",
    es: "Aprenda a generar Enlaces Mágicos únicos para obtener confirmaciones de lectura en tiempo real y rastrear cuándo sus invitados abren sus invitaciones.",
    fr: "Apprenez à générer des Liens Magiques uniques pour vos cartes numériques afin d'obtenir des accusés de lecture en temps réel.",
    ar: "تعلم كيفية إنشاء روابط سحرية فريدة لبطاقاتك الرقمية للحصول على إيصالات قراءة في الوقت الفعلي وتتبع متى يفتح ضيوفك دعواتك.",
    hi: "अपने डिजिटल कार्ड के लिए अद्वितीय मैजिक लिंक उत्पन्न करना सीखें और वास्तविक समय में देखें कि आपके मेहमानों ने आपके कार्ड कब खोले।",
    zh: "了解如何为您的数字贺卡生成独特的魔法链接，以获得实时已读回执并精确跟踪您的客人何时打开您的邀请函或祝福语。",
    pt: "Aprenda a gerar Links Mágicos exclusivos para seus cartões digitais para obter recibos de leitura em tempo real e rastrear quando seus convidados abrem seus convites ou desejos.",
    ru: "Узнайте, как создавать уникальные волшебные ссылки для ваших цифровых открыток, чтобы получать отчеты о прочтении в реальном времени.",
    de: "Erfahren Sie, wie Sie einzigartige Magic Links für Ihre digitalen Karten generieren, um Echtzeit-Lesebestätigungen zu erhalten.",
    ja: "デジタルカード用の独自のマジックリンクを生成し、ゲストが招待状を開いた正確な時間を追跡する方法を学びます。",
    ko: "디지털 카드를 위한 고유한 매직 링크를 생성하여 실시간 읽음 확인을 받고 게스트가 초대장을 여는 정확한 시간을 추적하는 방법을 알아보세요.",
    it: "Scopri come generare Magic Link unici per le tue carte digitali per ottenere conferme di lettura in tempo reale.",
    tr: "Dijital kartlarınız için benzersiz Sihirli Bağlantılar oluşturmayı öğrenin ve misafirlerinizin davetiyelerinizi tam olarak ne zaman açtığını takip edin.",
    id: "Pelajari cara membuat Tautan Ajaib unik untuk kartu digital Anda guna mendapatkan tanda terima baca secara real-time.",
    ur: "جانیں کہ اپنے ڈیجیٹل کارڈز کے لیے منفرد میجک لنکس کیسے بنائیں تاکہ آپ کو ریئل ٹائم میں معلوم ہو سکے کہ آپ کے مہمانوں نے کب آپ کا کارڈ کھولا۔",
    bn: "রিয়েল-টাইম রিড রিসিপ্ট পেতে এবং আপনার অতিথিরা ঠিক কখন আপনার আমন্ত্রণ বা শুভেচ্ছা খুলবে তা ট্র্যাক করতে আপনার ডিজিটাল কার্ডের জন্য কীভাবে অনন্য ম্যাজিক লিঙ্ক তৈরি করবেন তা জানুন।",
    vi: "Tìm hiểu cách tạo Liên kết Ma thuật độc đáo cho thiệp kỹ thuật số của bạn để nhận thông báo đã đọc trong thời gian thực.",
    sw: "Jifunze jinsi ya kutengeneza Viungo vya Kichawi vya kipekee kwa kadi zako za dijitali ili kupata risiti za kusoma za wakati halisi."
  },
  newFeature: {
    en: "New Feature",
    es: "Nueva Función",
  ...
  dateSep21: {
    ...
    es: "21 de Septiembre de 2026",
    fr: "21 Septembre 2026",
    ar: "٢١ سبتمبر ٢٠٢٦",
    hi: "२१ सितंबर २०२६",
    zh: "2026 年 9 月 21 日",
    pt: "21 de Setembro de 2026",
    ru: "21 Сентября 2026 г.",
    de: "21. September 2026",
    ja: "2026年9月21日",
    ko: "2026년 9월 21일",
    it: "21 Settembre 2026",
    tr: "21 Eylül 2026",
    id: "21 September 2026",
    ur: "21 ستمبر 2026",
    bn: "২১ সেপ্টেম্বর ২০২৬",
    vi: "Ngày 21 tháng 9 năm 2026",
    sw: "Septemba 21, 2026"
  },
  catPoetry: {
    en: "Poetry & Shayari",
    ...
    bn: "কবিতা ও শায়ারি",
    vi: "Thơ Ca & Danh Ngôn",
    sw: "Mashairi na Shayari"
  },
  poetryGuideTitle: {
    en: "The Ultimate Guide to Cardzy’s 1,000+ Poetry Treasury & Royal Story Cards",
    ur: "کارڈزی کا 1,000+ شاعری گنجینہ اور رائل اسٹوری کارڈز: مکمل گائیڈ",
    es: "Mejor Poesía Urdu y Mundial para Tarjetas de Boda y Deseos 3D",
    fr: "Meilleure Poésie Ourdou et Mondiale pour Faire-part et Vœux 3D",
    ar: "أفضل الأشعار الأردية والعالمية لبطاقات الزفاف والدعوات الرقمية",
    hi: "वेडिंग कार्ड और 3D विशेस के लिए सर्वश्रेष्ठ उर्दू व विश्व कविता",
    zh: "精选乌尔都语与世界经典诗歌：婚礼贺卡与 3D 祝贺全指南",
    pt: "Melhor Poesia Urdu e Mundial para Convites de Casamento e Cartões 3D",
    ru: "Лучшая поэзия на урду и мировая классика для свадебных открыток",
    de: "Beste Urdu- und Weltpoesie für Hochzeitskarten & 3D-Wünsche",
    ja: "結婚式カードと3Dウィッシュに最適なウルドゥー語と世界の名詩",
    ko: "웨딩 카드 및 3D 축하 카드를 위한 최고의 우르두어 및 세계 명시",
    it: "Migliore Poesia Urdu e Mondiale per Biglietti di Nozze e Auguri 3D",
    tr: "Düğün Kartları ve 3D Dilekler İçin En Güzel Urduca ve Dünya Şiirleri",
    id: "Puisi Urdu & Dunia Terbaik untuk Kartu Pernikahan & Ucapan 3D",
    bn: "বিয়ের কার্ড ও ৩ডি উইশের জন্য সেরা উর্দু ও বিশ্ব কবিতা",
    vi: "Thơ Ca Urdu & Thế Giới Hay Nhất Cho Thiệp Cưới & Thiệp 3D",
    sw: "Mashairi Bora ya Kiurdu na Ulimwengu kwa Kadi za Harusi na 3D"
  },
  poetryGuideDesc: {
    en: "Explore 1,000+ verified verses from Allama Iqbal, Mirza Ghalib, Faiz, and Rumi. Learn to use multi-filters, download 1080px gold-framed story cards, and share on WhatsApp.",
    ur: "علامہ اقبال، مرزا غالب، فیض اور رومی کے 1,000+ تصدیق شدہ اشعار دریافت کریں، 1080px رائل اسٹوری کارڈز ڈاؤن لوڈ کریں اور واٹس ایپ پر شیئر کریں۔",
    es: "Descubre versos listos para copiar de Allama Iqbal, Mirza Ghalib, Faiz y Rumi con consejos de diseño y generación de tarjetas 3D en 1 clic.",
    fr: "Découvrez des distiques prêts à copier d'Allama Iqbal, Mirza Ghalib, Faiz et Rumi avec règles de calligraphie et cartes 3D en 1 clic.",
    ar: "اكتشف أبياتاً جاهزة للنسخ من إقبال وغالب وفيض ورومي مع قواعد التنسيق وتصميم بطاقات ثلاثية الأبعاد بضغطة زر واحدة.",
    hi: "अल्लामा इकबाल, मिर्ज़ा ग़ालिब, फैज़ और रूमी की चुनिंदा शायरी, डिजाइन नियम और 1-क्लिक में 3D कार्ड बनाएं।",
    zh: "汇集伊克巴尔、迦利布、法伊兹与鲁米传世名句，搭配传统字体排版建议及一键生成 3D 祝贺卡。",
    pt: "Descubra versos prontos para copiar de Allama Iqbal, Mirza Ghalib, Faiz e Rumi com dicas de design e geração de cartões 3D.",
    ru: "Откройте для себя проверенные двустишия Икбала, Галиба, Фаиза и Руми с правилами верстки и открытками в 1 клик.",
    de: "Entdecken Sie Verse von Allama Iqbal, Mirza Ghalib, Faiz und Rumi mit Designregeln und 1-Klick-3D-Karten.",
    ja: "アッラーマ・イクバール、ガーリブ、ファイ自由詩人、ルーミーの選りすぐりの詩句と3Dカード作成ガイド。",
    ko: "알라마 이크발, 미르자 갈립, 파이즈, 루미의 명시를 복사해 1클릭으로 3D 카드를 만들어 보세요.",
    it: "Scopri versi pronti da copiare di Allama Iqbal, Mirza Ghalib, Faiz e Rumi con regole di design e biglietti 3D in 1 clic.",
    tr: "İkbal, Galib, Faiz ve Mevlana'dan kopyalamaya hazır beyitler, hat kuralları ve 1 tıkla 3D kart oluşturma.",
    id: "Temukan bait-bait pilihan dari Allama Iqbal, Mirza Ghalib, Faiz, dan Rumi lengkap dengan panduan kartu 3D 1-klik.",
    bn: "আল্লামা ইকবাল, মির্জা গালিব, ফয়েজ ও রুমির সেরা শের ও ১-ক্লিকে ৩ডি কার্ড বানানোর উপায়।",
    vi: "Khám phá các câu thơ mẫu từ Allama Iqbal, Mirza Ghalib, Faiz và Rumi cùng hướng dẫn tạo thiệp 3D 1 chạm.",
    sw: "Gundua mashairi yaliyo tayari ya Allama Iqbal, Mirza Ghalib, Faiz na Rumi pamoja na kutengeneza kadi za 3D kwa mbofyo 1."
  },
  dateSep24: {
    ...
    ru: "24 Сентября 2026 г.",
    de: "24. September 2026",
    ja: "2026年9月24日",
    ko: "2026년 9월 24일",
    it: "24 Settembre 2026",
    tr: "24 Eylül 2026",
    id: "24 September 2026",
    bn: "২৪ সেপ্টেম্বর ২০২৬",
    vi: "Ngày 24 tháng 9 năm 2026",
    sw: "Septemba 24, 2026"
  }
}
...
const GUIDES = [
  {
    slug: 'poetry-for-cards-and-invitations',
    titleKey: 'poetryGuideTitle',
    descKey: 'poetryGuideDesc',
    catKey: 'catPoetry',
  ...
  {
    slug: 'magic-links-guide',
    titleKey: 'magicGuideTitle',
    descKey: 'magicGuideDesc',
    catKey: 'newFeature',
