      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="p-5 rounded-3xl border border-border/80 bg-gradient-to-br from-card via-card/90 to-card shadow-xs mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
            ...
            {/* 7. Apps Share */}
            <div className="group relative p-3 rounded-2xl bg-gradient-to-br from-indigo-500/10 via-indigo-500/5 to-card/50 border border-indigo-500/20 hover:border-indigo-500/40 hover:shadow-xs transition-all duration-200">
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[11px] font-bold text-muted-foreground">Apps Share</span>
                <span className="text-sm">📲</span>
              </div>
              <div className="text-2xl font-black text-indigo-600 dark:text-indigo-400 font-mono tracking-tight">
                {totalHostShares.app.toLocaleString()}
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div key={inv.id} className="rounded-2xl border border-border bg-card p-5 shadow-sm flex flex-col justify-between hover:border-emerald-500/40 hover:shadow-md transition-all">
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 text-[11px] mt-3.5 pt-2.5 border-t border-border/50">
                          ...
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 font-extrabold border border-indigo-500/20 shadow-2xs" title="Shared via Apps (Instagram / Messages)">
                            📲 {inv.shares?.app || 0}
                          </span>
                        </div>
                      </div>
