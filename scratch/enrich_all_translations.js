...
// Comprehensive dictionary for text translation across all 18 languages
const DICT = {
  // Common phrases for Wedding Post (Post 1)
  p1_sub: {
...
console.log("Enrichment dictionary module created.");
